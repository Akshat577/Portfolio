  ...
  return (
    <motion.div variants={textVariant()} className='min-h-screen flex justify-center items-center flex-col bg-primary'>
      ...
      <motion.div className='p-10 sm:p-20 z-10' style={{ opacity: calculateOpacity() }}>
        ...
        <motion.p variants={textVariant(0.1)} className='text-textlight text-7xl sm:text-[10rem] font-bold tracking-tighter mt-0 -sm:mt-10 -ml-1'>AKSHAT JAIN</motion.p>
        <motion.p variants={textVariant(0.05)} className='text-textlight text-lg sm:text-2xl text-left sm:text-center -sm:mt-8'>I'm a Pre-Final Year student at IIT Hyderabad.</motion.p>
      </motion.div>
    </motion.div>
  )
}
