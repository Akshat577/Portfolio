            ...
            <footer className="relative p-6 sm:p-20 w-full">
                <div className="w-full flex justify-around sm:text-sm flex-wrap">
                    ...
                    <div className="flex flex-col md:col-span-6 lg:col-span-6">
                        ...
                        <div className='w-full h-[1px] bg-textlight mx-auto mb-3'></div>
                        <div className="flex flex-col gap-y-2">
                            <a className="relative h-fit w-fit overflow-hidden font-medium text-texlight" href="https://www.linkedin.com/in/akshat-jain-404746254/" target='_blank'>
                                <ArrowRightIcon /><span className="link1">LinkedIn</span>
                            </a>
                            <a className="relative h-fit w-fit overflow-hidden font-medium text-texlight" href="https://github.com/Akshat577" target='_blank'>
                                <ArrowRightIcon /><span className="link1">Github</span>
                            </a>
                            <a className="relative h-fit w-fit overflow-hidden font-medium text-texlight" href="https://leetcode.com/u/akshatjain5773/" target='_blank'>
